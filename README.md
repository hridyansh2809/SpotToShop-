...
An intelligent application designed to detect items/products within streaming video scenes (e.g., from Prime Video) and match them with Amazon product databases for a seamless search-and-shop experience.
...
* Clone the repository to your local setup using the command: `git clone https://github.com/hridyansh2809/SpotToShop-.git`
